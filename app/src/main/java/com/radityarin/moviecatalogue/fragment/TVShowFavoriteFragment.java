 ...
 */
public class TVShowFavoriteFragment extends Fragment implements LoadMovieCallbacks {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_tvshow_favorite, container, false);
    ...
    public void postExecute(Cursor movies) {
        ...
        if (listMovies.size() > 0) {
            ...
            Log.d("Cek",String.valueOf(listMovies.size()));
        } else {
